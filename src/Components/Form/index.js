            ...
            <div>
              <div style={{ display: "flex", justifyContent: "center" }}>
                <h1>
                  ...
                  <span className="primary-color">today?</span>
                </h1>
              </div>
              <div style={{ display: "flex", justifyContent: "center" }}>
            ...
            >
              <div class="card">
                <svg
                  ...
                  width="260"
                  height="241"
                  viewBox="0 0 2876.0933 2666.6667"
                  class="top"
                >
                  ...
                  />
                  <path
                    d="M1149.77 1671.667c-63.026 16.44-306.07 53.88-334.642 64.533l148.207 151.747h217.05l-30.614-216.28"
                    fill="#f7a491"
                  />
                  <path
                  ...
                  />
                  <path
                    d="M685.1 1515.813s-54.797-10.493-63.893 37.214c0 0 21.257-37.347 63.892-37.214"
                    fill="#944634"
                  />
                  <path
